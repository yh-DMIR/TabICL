...
CHECKPOINT_VERSION=${CHECKPOINT_VERSION:-tabicl-classifier-v1-0208.ckpt}
MODEL_PATH=${MODEL_PATH:-tabicl-classifier-v1-0208.ckpt}
OUT_DIR=${OUT_DIR:-results/official_classification_v1}
WORKERS=${WORKERS:-8}
